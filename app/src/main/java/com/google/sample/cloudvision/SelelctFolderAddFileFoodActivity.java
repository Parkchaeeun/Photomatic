...
public class SelelctFolderAddFileFoodActivity extends AppCompatActivity {

    Bitmap bitmap1,bitmap2,bitmap3,bitmap4,bitmap5,bitmap6;
    private static String TAG = "php_selectFolderAddFileFoodActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selelct_folder_add_file_food);

        pref = getSharedPreferences("pref", Context.MODE_PRIVATE);
        email = pref.getString("email", ""); //이메일
        cate = pref.getString("cate", "");  //카테고리 값

        btn1=(Button)findViewById(R.id.selectFolderFood_1);
        btn2=(Button)findViewById(R.id.selectFolderFood_2 );
        btn3=(Button)findViewById(R.id.selectFolderFood_3);
        btn4=(Button)findViewById(R.id.selectFolderFood_4);
        btn5=(Button)findViewById(R.id.selectFolderFood_5);
        btn6=(Button)findViewById(R.id.selectFolderFood_6);
    ...
    public class folderView extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(SelelctFolderAddFileFoodActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                Log.d(TAG, "selectFolderaddFileFood: Error ", e);
