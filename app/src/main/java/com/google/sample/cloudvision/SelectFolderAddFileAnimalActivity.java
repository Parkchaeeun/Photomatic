...
public class SelectFolderAddFileAnimalActivity extends AppCompatActivity {
    ...
    private static String TAG = "php_selectFolderAddFileAnimalActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_folder_add_file_animal);

        pref = getSharedPreferences("pref", Context.MODE_PRIVATE);
        email = pref.getString("email", ""); //이메일
        cate = pref.getString("cate", "");  //카테고리 값

        btn1=(Button)findViewById(R.id.selectFolderAnimal_1);
        btn2=(Button)findViewById(R.id.selectFolderAnimal_2);
        btn3=(Button)findViewById(R.id.selectFolderAnimal_3);
        btn4=(Button)findViewById(R.id.selectFolderAnimal_4);
        btn5=(Button)findViewById(R.id.selectFolderAnimal_5);
        btn6=(Button)findViewById(R.id.selectFolderAnimal_6);

        if (getIntent().getByteArrayExtra("image_1") != null) {
            byte[] arr = getIntent().getByteArrayExtra("image_1");
            bitmap1 = BitmapFactory.decodeByteArray(arr, 0, arr.length);   //nullpointerexception
        }
    ...
    public class folderView extends AsyncTask<String,Void,String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(SelectFolderAddFileAnimalActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                Log.d(TAG, "selectFolderaddFileAnimal: Error ", e);
