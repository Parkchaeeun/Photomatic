...
public class SelectFolderAddFileTextActivity extends AppCompatActivity {

    private static String TAG = "php_selectFolderAddFileTextActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_folder_add_file_text);

        pref = getSharedPreferences("pref", Context.MODE_PRIVATE);
        email = pref.getString("email", ""); //이메일
        cate = pref.getString("cate", "");  //카테고리 값

        btn1=(Button)findViewById(R.id.selectFolderText_1);
        btn2=(Button)findViewById(R.id.selectFolderText_2 );
        btn3=(Button)findViewById(R.id.selectFolderText_3);
        btn4=(Button)findViewById(R.id.selectFolderText_4);
        btn5=(Button)findViewById(R.id.selectFolderText_5);
        btn6=(Button)findViewById(R.id.selectFolderText_6);
    ...
    public class folderView extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(SelectFolderAddFileTextActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                Log.d(TAG, "selectFolderaddFileText: Error ", e);
