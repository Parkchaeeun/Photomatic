...
public class SelectFolderAddFileHumanActivity extends AppCompatActivity {
    ...
    private static String TAG = "php_selectFolderAddFileHumanActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_folder_add_file_human);

        pref = getSharedPreferences("pref", Context.MODE_PRIVATE);
        email = pref.getString("email", ""); //이메일
        cate = pref.getString("cate", "");  //카테고리 값

        btn1=(Button)findViewById(R.id.selectFolderHuman_1);
        btn2=(Button)findViewById(R.id.selectFolderHuman_2 );
        btn3=(Button)findViewById(R.id.selectFolderHuman_3);
        btn4=(Button)findViewById(R.id.selectFolderHuman_4);
        btn5=(Button)findViewById(R.id.selectFolderHuman_5);
        btn6=(Button)findViewById(R.id.selectFolderHuman_6);
        ...
        if (getIntent().getByteArrayExtra("image_4") != null) {
            ...
            bitmap4 = BitmapFactory.decodeByteArray(arr, 0, arr.length);  //nullpointerexception
    ...
    public class folderView extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(SelectFolderAddFileHumanActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                Log.d(TAG, "selectFolderaddFileHuman: Error ", e);
