...
public class SelectFolderAddFileLandscapeActivity extends AppCompatActivity {

    private static String TAG = "php_selectFolderAddFileLandscapeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_folder_add_file_landscape);
        ...
        btn1=(Button)findViewById(R.id.selectFolderLandscape_1);
        btn2=(Button)findViewById(R.id.selectFolderLandscape_2);
        btn3=(Button)findViewById(R.id.selectFolderLandscape_3);
        btn4=(Button)findViewById(R.id.selectFolderLandscape_4);
        btn5=(Button)findViewById(R.id.selectFolderLandscape_5);
        btn6=(Button)findViewById(R.id.selectFolderLandscape_6);
    ...
    public class folderView extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(SelectFolderAddFileLandscapeActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                Log.d(TAG, "selectFolderaddFileLandscape: Error ", e);
